...
public class MainController_scrollZoom implements GsehenEventListener<FarmDataChanged> {
  {
  ...
  private static final Logger LOGGER = Logger.getLogger(MainController_scrollZoom.class.getName());
  ...
  private void enterFarmView() {
    ...
    farmViewBorderPane.setCenter(farmVBox);
    drawCanvas(canvas);
  ...
  private void drawCanvas(Canvas canvas) {
    ...
    // double ratio = canvasImage.getWidth() / canvasImage.getHeight();
